...
class Laporan3PageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan3PageA> {
  File? _image;
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: TextField(
              controller: TextEditingController(text: widget.nilaiRedaman),
