...
class Laporan4PageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan4PageA> {
  File? _image;
        ...
        children: [
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[Image.network(widget.pullstrap)],
                  ),
                ),
              )),
          const SizedBox(
          ...
          Container(
            ...
            child: TextField(
              ...
              controller: TextEditingController(text: widget.nilaiPullstrap),
