...
class Laporan12PageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan12PageA> {
  File? _image;
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              cursorColor: Colors.red,
              controller:
                  TextEditingController(text: widget.nilaiRumahPelanggan),
