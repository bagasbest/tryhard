...
class Laporan8PageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan8PageA> {
  File? _image;
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              controller: TextEditingController(text: widget.nilaiRoset),
