...
class Laporan9PageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan9PageA> {
  File? _image;
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              controller:
                  TextEditingController(text: widget.nilaiJalurPatchcore),
            ...
            child: GestureDetector(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Laporan10PageA(
                              name: widget.name,
