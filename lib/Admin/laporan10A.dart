...
class Laporan10PageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan10PageA> {
  File? _image;
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              controller: TextEditingController(text: widget.nilaiRedamanOut),
            ...
            child: GestureDetector(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Laporan11PageA(
                              name: widget.name,
