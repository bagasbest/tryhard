...
class Laporan11PageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan11PageA> {
  File? _image;
        ...
        children: [
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[
                      Image.network(widget.teknisiDenganPelanggan)
                    ],
                  ),
                ),
              )),
          ...
          Container(
            ...
            child: TextField(
              ...
              controller: TextEditingController(text: widget.nilaiTnP),
            ...
            child: GestureDetector(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Laporan12PageA(
                              name: widget.name,
