...
class LaporanPageA extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<LaporanPageA> {
  File? _image;
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: TextField(
              cursorColor: Colors.red,
              controller: TextEditingController(text: widget.nilaiPsb),
              decoration: InputDecoration(
