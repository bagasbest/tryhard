...
import 'package:tryhard/Admin/laporan4A.dart';
import 'dart:io';

import 'package:tryhard/TL/laporan4TL.dart';

import '../Admin/loginA.dart';

class Laporan3PageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan3PageTL> {
  File? _image;
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[Image.network(widget.redaman)],
                  ),
                ),
              )),
          const SizedBox(
              ...
              onTap: () {
                if (penilaian.text.isNotEmpty) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Laporan4PageTL(
                                name: widget.name,
