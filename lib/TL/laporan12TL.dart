...
class Laporan12PageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan12PageTL> {
  File? _image;
        ...
        children: [
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[Image.network(widget.rumahPelanggan)],
                  ),
                ),
              )),
          const SizedBox(
          ...
          Container(
            ...
            child: TextField(
              ...
              controller: TextEditingController(text: widget.panjangDc),
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => ReviewPageTL(
                                ...
                                nilaiRumahPelanggan: penilaian.text,
