...
class LaporanPenilaianTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<LaporanPenilaianTL> {
        ...
        GestureDetector(
          ...
          onTap: () async {
            if (name.text.isNotEmpty &&
              ...
              String tlId = FirebaseAuth.instance.currentUser!.uid;
              await Data.uploadReportUpdate(
                widget.uid,
                tlId,
                widget.nilaiPsb,
                widget.nilaiOdp,
                widget.nilaiRedaman,
                widget.nilaiPullstrap,
                widget.nilaiHook,
                widget.nilaiHookLong,
                widget.nilaiJalurIkr,
                widget.nilaiJalurPatchcore,
                widget.nilaiRedamanOut,
                widget.nilaiRoset,
                widget.nilaiRumahPelanggan,
                widget.nilaiTnP,
                phone.text,
                name.text,
                date.text,
