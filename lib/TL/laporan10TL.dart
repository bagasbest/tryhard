...
import 'package:tryhard/Admin/laporan11A.dart';
import 'dart:io';

import 'package:tryhard/TL/laporan11TL.dart';

import '../Admin/loginA.dart';

class Laporan10PageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan10PageTL> {
  File? _image;
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[Image.network(widget.redamanOut)],
                  ),
                ),
              )),
          const SizedBox(
              ...
              onTap: () {
                if (penilaian.text.isNotEmpty) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Laporan11PageTL(
                                name: widget.name,
                                ...
                                nilaiRedamanOut: penilaian.text,
