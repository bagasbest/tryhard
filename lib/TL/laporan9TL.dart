...
import 'package:tryhard/Admin/laporan10A.dart';
import 'dart:io';

import 'package:tryhard/TL/laporan10TL.dart';

import '../Admin/loginA.dart';

class Laporan9PageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan9PageTL> {
  File? _image;
  final penilaian = TextEditingController();
        ...
        children: [
          ...
          Container(
            ...
            children: <Widget>[
              Align(
                ...
                child: Text(
                  "JALUR PATCHCORE DAN PENEMPATAN ONT",
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[Image.network(widget.jalurPatchcore)],
                  ),
                ),
              )),
          const SizedBox(
          ...
          Padding(
            ...
            child: GestureDetector(
              ...
              onTap: () {
                if (penilaian.text.isNotEmpty) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Laporan10PageTL(
                                name: widget.name,
                                ...
                                nilaiJalurPatchcore: penilaian.text,
