...
import 'package:tryhard/Admin/laporan5A.dart';
import 'dart:io';

import 'package:tryhard/TL/laporan5TL.dart';

import '../Admin/loginA.dart';

class Laporan4PageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan4PageTL> {
  File? _image;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Image.network(widget.pullstrap)
                    ],
                  ),
                ),
              )),
              ...
              onTap: () {
                if (penilaian.text.isNotEmpty) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Laporan5PageTL(
                                name: widget.name,
