...
import 'package:tryhard/Admin/laporan9A.dart';
import 'dart:io';

import 'package:tryhard/TL/laporan9TL.dart';

import '../Admin/loginA.dart';

class Laporan8PageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan8PageTL> {
  File? _image;
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[Image.network(widget.roset)],
                  ),
                ),
              )),
          const SizedBox(
              ...
              onTap: () {
                if (penilaian.text.isNotEmpty) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Laporan9PageTL(
                                name: widget.name,
