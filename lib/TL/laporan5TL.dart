...
import 'package:tryhard/Admin/laporan6A.dart';
import 'package:tryhard/Admin/loginA.dart';
import 'dart:io';

import 'package:tryhard/TL/laporan6TL.dart';

class Laporan5PageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<Laporan5PageTL> {
  File? _image;
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: <Widget>[Image.network(widget.hook)],
                  ),
                ),
              )),
          const SizedBox(
              ...
              onTap: () {
                if (penilaian.text.isNotEmpty) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Laporan6PageTL(
                                name: widget.name,
