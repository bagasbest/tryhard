...
class LaporanPageTL extends StatefulWidget {
  final String name;
  final String myirSc;
  final String dateWo;
  final String uid;
...
class InitState extends State<LaporanPageTL> {
  File? _image;
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              cursorColor: Colors.red,
              controller: TextEditingController(text: widget.dateWo),
              decoration: InputDecoration(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  mainAxisSize: MainAxisSize.max,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: <Widget>[Image.network(widget.jalurKeluarPsb)],
                ),
              ),
            ),
          ),
              ...
              onTap: () {
                if (penilaian.text.isNotEmpty) {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Laporan2PageTL(
                                name: widget.name,
