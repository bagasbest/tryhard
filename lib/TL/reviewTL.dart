...
class InitState extends State<ReviewPageTL> {
  final myirSc = TextEditingController();
  ...
  void initState() {
    super.initState();
    myirSc.text = widget.myirSc;
    customerAddress.text = widget.customerAddress;
          ...
          onTap: () {
            if (myirSc.text.isNotEmpty &&
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => LaporanPenilaianTL(
                            name: widget.name,
                            myirSc: myirSc.text,
